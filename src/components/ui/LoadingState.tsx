...
export const LoadingState = forwardRef<HTMLDivElement, LoadingStateProps>(({ fullPage = false }, ref) => {
  return (
    <div
      ref={ref}
      className={`flex flex-col items-center justify-center transition-opacity duration-300 ${fullPage ? "fixed inset-0 z-[9999] bg-black" : "h-[60vh] w-full bg-transparent"}`}
    >
