          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "whitespace-nowrap px-5 py-2 rounded-full text-[9px] font-black uppercase tracking-[0.15em] transition-all duration-300 border relative",
                  isActive
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="flex items-center gap-2 bg-black/60 backdrop-blur-xl px-4 py-2.5 rounded-full border border-white/10 relative">
                  ...
                  <button
                    ...
                    className="relative w-7 h-7 flex items-center justify-center bg-white text-black rounded-full transition-transform active:scale-90 shadow-2xl"
                  >
