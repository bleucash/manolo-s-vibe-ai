  ...
  return (
    <div className="h-screen bg-black overflow-hidden flex flex-col font-body">
      ...
      <div className="fixed top-0 left-0 right-0 z-[150] bg-black pt-4 overflow-visible">
        ...
        <div className="max-w-3xl lg:max-w-4xl mx-auto px-8 mb-6 overflow-visible">
      ...
      >
        ...
        <div className="min-h-[75dvh] w-full snap-center relative flex flex-col justify-start bg-black pt-4 pb-12">
          <div className="flex overflow-x-auto gap-6 px-8 hide-scrollbar scroll-smooth pb-10">
            {featuredTalent.map((talent) => (
              ...
              >
                <div className="relative w-[75vw] sm:w-[45vw] md:w-[35vw] lg:w-[28vw] xl:w-80 h-[50dvh] rounded-[2.5rem] bg-zinc-950 border border-white/5 overflow-hidden">
                  <img
        ...
        {/* FEED SLIDES - Grid for tablets/desktop, full-width for mobile */}
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 pb-32">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 z-10">
                  <div className="flex items-center gap-2 mb-3">
                    <Badge className="bg-neon-blue text-white border-none text-[8px] font-black uppercase tracking-[0.15em] px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-[0_0_12px_rgba(0,229,255,0.4)]">
                  ...
                  <h3 className="font-display text-xl md:text-2xl text-white uppercase italic tracking-tight leading-tight line-clamp-2">
                ...
                <button
                  ...
                  className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center bg-white/90 text-black rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                >
                  {followedNodes.has(item.data.id) ? <Minus className="w-3.5 h-3.5" /> : <Plus className="w-3.5 h-3.5" />}
                </button>
              </div>
            ))}
          </div>
