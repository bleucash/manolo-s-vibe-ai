...
<div
  ...
  style={{ scrollSnapStop: "always" }}>
    ...
    <div
    className="absolute inset-0 gradient-overlay-card z-10 pt-0 pb-0 mt-0"
    style={{
      background: "linear-gradient(to top, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0.5) 40%, rgba(0, 0, 0, 0) 100%)"
    }} />
  ...
  return (
    <div className="h-screen bg-black overflow-hidden flex flex-col font-body relative">
      ...
      <div ref={scrollContainerRef} className="flex-1 overflow-y-scroll snap-y snap-mandatory hide-scrollbar pt-36">
        ...
        <div className="min-h-[52dvh] w-full snap-start scroll-mt-36 relative flex flex-col justify-center bg-black pt-[40px] pb-[25px]">
          <div className="flex overflow-x-auto gap-8 px-10 hide-scrollbar scroll-smooth items-center pt-[10px] pb-[10px] pl-[30px] pr-[30px] my-0">
            {loading ?
            <>
                {[1, 2, 3].map((i) =>
